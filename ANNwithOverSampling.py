# -*- coding: utf-8 -*-
"""
Created on Sat Dec  2 20:54:57 2017
...
# Splitting the dataset into the Training set and Test set and dealing with bias
...
classifier.add(Dense(output_dim = 27, init = 'uniform', activation = 'relu', input_dim = 52))
