...
Created on Sat Dec  2 00:56:31 2017
...
c.pop()
vif["features"] = c
features = (vif.loc[vif['VIF Factor'] < 2, ['features']]).values.tolist()
X = dataset[['campaign',
 'job_entrepreneur',
 'job_housemaid',
 'job_management',
...
classifier.add(Dense(output_dim = 3, init = 'uniform', activation = 'relu', input_dim = 21))
